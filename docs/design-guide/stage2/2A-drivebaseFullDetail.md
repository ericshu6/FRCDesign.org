...
!!! Warning
    It is a very common misconception that the robot’s IMU (eg: CTRE Pigeon, NavX) must be mounted at the center of the robot. The IMU can be mounted anywhere on the robot, as long as it is securely mounted. An easy place to mount the IMU is right on top of the RoboRIO.
