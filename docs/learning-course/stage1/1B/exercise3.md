...
<div class="slideshow-container">
  ...
  <div class="mySlides fade">
    <figure>
      <img src="/img/learning-course/stage1b/exercises/e3/e3s1.webp" style="width:100%; data-description="1. Draw the tube profiles for the frame. There is a an 0.125 in gap between the slanted tube and the vertical tube to allow for assembly tolerances."">
  ...
  <div class="mySlides fade">
    <figure>
      <img src="/img/learning-course/stage1b/exercises/e3/e3s2.webp" style="width:100%; data-description="2. Use the Extrude Individual Featurescript to extrude the tube profiles."">
  ...
  <div class="mySlides fade">
    <figure>
      <img src="/img/learning-course/stage1b/exercises/e3/e3s3.webp" style="width:100%; data-description="3. Use the Tube Converter Featurescript to convert the rectangles into hole patterned 1x1 thin-wall tube (0.0625 in thick wall)."">
  ...
  <div class="mySlides fade">
    <figure>
      <img src="/img/learning-course/stage1b/exercises/e3/e3s4.webp" style="width:100%; data-description="4. Use the Gusset Featurescript to add a corner gusset between the lower two tubes."">
  ...
  <div class="mySlides fade">
    <figure>
      <img src="/img/learning-course/stage1b/exercises/e3/e3s6.webp" style="width:100%; data-description="6. Next, draw the 5mm pitch 12T and 36T pulleys. Use a line to connect the two pulleys. Use the #PulleyPD_5mm() function to calculate the pitch diameters of the pulleys. Also space the 36T pulley to be 0.25 in from the vertical tube. This step fully constrains the location of the gears."">
  ...
  <div class="mySlides fade">
    <figure>
      <img src="/img/learning-course/stage1b/exercises/e3/e3s8.webp" style="width:100%; data-description="7. Add the belt c-c to the layout sketch for a 60T HTD5 belt using the #BeltCTC_5mm() function."">
  ...
  <div class="mySlides fade">
    <figure>
      <img src="/img/learning-course/stage1b/exercises/e3/e3s10.webp" style="width:100%; data-description="9. Finally, sketch a 2.5 in circle for the motor. Space the motor to be 0.125 in away from the slanted tube. The layout sketch is now fully defined."">
  ...
  <div class="mySlides fade">
    <figure>
      <img src="/img/learning-course/stage1b/exercises/e3/e3s11.webp" style="width:100%; data-description="10. Create the plate sketch on the outer face of the bottom tube. Begin by drawing the two 1.125 in diameter bearing holes. Add a 0.95 in for the bearing boss instead of the standard 0.8 in so that the 12T pulley on the motor can fit through the hole to assist with real life assembly. This will become more clear when you create the gearbox assembly."">
  ...
  <div class="mySlides fade">
    <figure>
      <img src="/img/learning-course/stage1b/exercises/e3/e3s12.webp" style="width:100%; data-description="11. Add a 2 in bolt circle for the motor with a circular pattern. Constrain the center of the top left hole to be coincident with the center line between the pulleys (coincident uses an infinite extension of the line)"">
  ...
  <div class="mySlides fade">
    <figure>
      <img src="/img/learning-course/stage1b/exercises/e3/e3s14.webp" style="width:100%; data-description="13. Draw the outline for the plate using centerpoint arcs and tangent lines. Space the bottom of the plate 0.25 in from the edge of the pitch circle for the 60T gear."">
  ...
  <div class="mySlides fade">
    <figure>
      <img src="/img/learning-course/stage1b/exercises/e3/e3s15.webp" style="width:100%; data-description="14. Add two holes for spacers. The construction circles represent the 0.375 in diameter spacer. The top hole is tangent with the left edge of the plate and tangent with the 2.5 in motor circle."">
  ...
  <div class="mySlides fade">
    <figure>
      <img src="/img/learning-course/stage1b/exercises/e3/e3s16.webp" style="width:100%; data-description="15. Extrude the plate to be 0.25 in thick."">
  ...
  <div class="mySlides fade">
    <figure>
      <img src="/img/learning-course/stage1b/exercises/e3/e3s19.webp" style="width:100%; data-description="18. Extrude the inner plate to be 0.25 in thick."">
  ...
  <div class="mySlides fade">
    <figure>
      <img src="/img/learning-course/stage1b/exercises/e3/e3s20.webp" style="width:100%; data-description="19. Add a 0.1875 in radius fillet on the two edges for the motor cutout. The radius is selected to match the 0.375 in diameter spacer."">
  ...
  <div class="mySlides fade">
    <figure>
      <img src="/img/learning-course/stage1b/exercises/e3/e3s21.webp" style="width:100%; data-description="20. Model the 0.375 in diameter spacer. The Up to Face end condition can be utilized to keep the spacer length parametric."">
  ...
  <div class="mySlides fade">
    <figure>
      <img src="/img/learning-course/stage1b/exercises/e3/e3s23.webp" style="width:100%; data-description="22. Use the Shaft Generator Featurescript to create the 1st stage shaft. Note that this length is simply an estimate. While you could calculate the length of the shaft based on the components that will go on it, it is often easier to create the assembly then measure what the shaft length should be and update accordingly."">
  ...
  <div class="mySlides fade">
    <figure>
      <img src="/img/learning-course/stage1b/exercises/e3/e3s24.webp" style="width:100%; data-description="23. Use the Shaft Generator Featurescript to create the output shaft."">
  ...
  <div class="mySlides fade">
    <figure>
      <img src="/img/learning-course/stage1b/exercises/e3/e3s26.webp" style="width:100%; data-description="25. Use the Part Lighten Featurescript to add the pocketing by selecting the previous sketch. Use 0.15 in wide ribs and 0.26 in tool diameter."">
  ...
  <div class="mySlides fade">
    <figure>
      <img src="/img/learning-course/stage1b/exercises/e3/e3s27.webp" style="width:100%; data-description="26. Create a sketch on the inner plate and draw the strut lines. You can utilize the Use sketch feature to copy over strut lines from the motor plate pocketing sketch."">
  ...
  <div class="mySlides fade">
    <figure>
      <img src="/img/learning-course/stage1b/exercises/e3/e3s28.webp" style="width:100%; data-description="27. Use the Part Lighten Featurescript to add the pocketing by selecting the previous sketch. Again, use 0.15 in wide ribs and 0.26 in tool diameter."">
