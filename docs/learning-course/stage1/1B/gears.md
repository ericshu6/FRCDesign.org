...
<figure>
    <img src="\img\learning-course\stage1b\gears\simpleGears.gif" style="width:40%" data-description="A simple animation of two gears meshing. Notice that meshed gears will spin in opposite directions.">
...
<div id="slide1" class="mySlides fade">
    <figure>
        <img src="/img/learning-course/stage1b/gears/gearReduction.webp" style="width:100%" data-description="1. A 12T gear drives an 84T gear. The gear ratio is 84:12, which can be simplified to 7:1. The torque is increased by 7x while the speed is reduced to 1/7 of the original speed. (Image source: <a href="https://docs.wcproducts.com/frc-build-system/belts-chain-and-gears/gears">WCP</a>)">
...
<figure>
    <img src="\img\learning-course\stage1b\gears\gearDiagram.webp" style="width:70%" data-description="Illustration of a gear's pitch diameter and outer diameter. (Image source: <a href="https://docs.wcproducts.com/frc-build-system/belts-chain-and-gears/gears">WCP</a>).">
...
<figure>
<img src="\img\learning-course\stage1b\gears\gearCad.webp" style="width:60%" data-description="Modeling gear C-C distance by constraining two pitch diameter construction circles tangent. The diameters of the circle are calculated by dividing the tooth count by DP, which is 20 in this case.">
